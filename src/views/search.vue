      ...
      <el-table v-loading="loading" :data="accountList" style="width: 100%" height="450" :expand-row-keys="currentKey" row-key="id">
        ...
        <el-table-column label="操作" prop="">
          <template slot-scope="scope">
            ...
            <el-button size="mini" type="primary" @click="addFriend(scope.$index, scope.row)">添加</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-tab-pane>
    <el-tab-pane label="添加聊天室">
      ...
      <el-table :data="roomList" style="width: 100%"  height="450" :expand-row-keys="currentKey" row-key="id">
        ...
        <el-table-column label="操作" prop="">
          <template slot-scope="scope">
            <el-button size="mini" @click="handleEdit(scope.$index, scope.row)">查看</el-button>
            <el-button size="mini" type="primary" @click="addRoom(scope.$index, scope.row)">添加</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-tab-pane>
