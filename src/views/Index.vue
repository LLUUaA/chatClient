      ...
      <div class="aside-nav-bar">
        ...
        <ul>
          <template v-for="(nav, index) in navList">
            <li :key="index" :data-count="nav.newMsgCount" :class="{'current': currentIndex === nav.id,'new-msg': nav.newMsgCount > 0}" @click="navigateTo(nav,index)">
        ...
        <el-popover placement="top" width="160" v-model="popoverVisible">
          ...
          <div slot="reference" class="exit-btn">
